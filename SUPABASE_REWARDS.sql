...
-- Currency and address columns for price submissions
ALTER TABLE price_submissions ADD COLUMN IF NOT EXISTS currency TEXT;
ALTER TABLE price_submissions ADD COLUMN IF NOT EXISTS gas_station_address TEXT;
